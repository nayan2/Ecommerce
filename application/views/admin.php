	                    ...
	                    <ul class="nav navbar-nav">
	                      <li class="dropdown">
	                        ...
	                        <ul class="dropdown-menu animated fadeInUp">
	                          ...
	                          <li><a href="<?php echo base_url(); ?>admin/login.html">Logout</a></li>
	                        </ul>
	                      </li>
	                    </ul>
	                  </nav>
    ...
    <div class="page-content">
    	<div class="row">
		  <div class="col-md-2">
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
                    ...
                    <li><a href="<?php echo base_url(); ?>admin/calendar.html"><i class="glyphicon glyphicon-calendar"></i> Calendar</a></li>
                    <li><a href="<?php echo base_url(); ?>admin/stats.html"><i class="glyphicon glyphicon-stats"></i> Statistics (Charts)</a></li>
                    <li><a href="<?php echo base_url(); ?>admin/tables.html"><i class="glyphicon glyphicon-list"></i> Tables</a></li>
                    <li><a href="<?php echo base_url(); ?>admin/buttons.html"><i class="glyphicon glyphicon-record"></i> Buttons</a></li>
                    <li><a href="<?php echo base_url(); ?>admin/editors.html"><i class="glyphicon glyphicon-pencil"></i> Editors</a></li>
                    <li><a href="<?php echo base_url(); ?>admin/forms.html"><i class="glyphicon glyphicon-tasks"></i> Forms</a></li>
                    <li class="submenu">
                         <a href="#">
                         ...
                         <!-- Sub menu -->
                         <ul>
                            <li><a href=<?php echo base_url(); ?>admin/"login.html">Login</a></li>
                            <li><a href="<?php echo base_url(); ?>admin/signup.html">Signup</a></li>
                        </ul>
                    </li>
                </ul>
             </div>
		  ...
		  <div class="col-md-10">
		  	...
		  	<div class="content-box-large">
				Vivamus suscipit dui id tristique venenatis. Integer vitae dui egestas, ultrices augue et, luctus arcu. Sed pharetra lectus eget vea, quis malesuada tellus. Praesent consectetur gravida feugiat. In mi orci, malesuada sit amet lectus quis, tempor sollicitudin nibh. Nam ut nibh sit amet luctus. Aenean ultricies elementum posuere. Praesent ut felis id metus auctor egestas at id augue.
				<br /><br />
			     ti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Ut lobortis risus  at convallis dictum. Cras luctus, leo ac vestibulum ultrices, justo mi iaculis libero, non gravida arcu erat ut augue. Ut facilisis mollis quam, ut vestibulum magna placerat eu. Integer vulputate odio a lectus tincidunt placerat viverra vel est.
				<br /><br />
				  Ut non tincidunt felis. Aliquam urna lacus, dictum vitae dignissim id, molestie vel urna. Quisque et auctor eros, a vulputate nibh. Praesent et dictum risus, vitae congue arcu. In licitudin felis nulla in purus. Nunc vitae erat vitae nibh pellentesque adipiscing. In dignissim dolor vitae metus eleifend, at tincidunt massa luctus. Suspendisse id ligula non leo tincidunt tempor.
				<br /><br />
				Nullam vel ligula arcu. Vivamus convallis libero auctor ante imperdiet, eget adipiscing   nunc eg
				<br /><br />
				Duis iaculis enim eu massa rhoncus, a aliquam lorem sollicitudin. Sed elementum, dolor sit amet interdum euismod, orci diam vestibulum leo, vel mattis justo sapien in justo. Aenean purus et elit convallis facilisis. Vivamus vitae dolor sit amet ante faucibus ornare eu non diam. Donec felis leo, malesuada eu lectus ac, facilisis posuere lorem.
				<br /><br />
				Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos